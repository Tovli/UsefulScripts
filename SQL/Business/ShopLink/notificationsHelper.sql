-- insert into Arch_notificationScheuduling (NotificationId,
--MemberId,
--NotificationType,
--DayOfMonth,
--TimeOfDay,
...
--truncate table notificationScheduling
------------------------------------------------------------------------------
...
<img src="" alt="תזכורת לדיוווח פדיון" width="300" height="230" style="display:block" />
</td>
</tr>
<tr>
...
שלום רב. מצורף בזאת לינק לאתר באמצעותו הנך מתבקש לדווח את הפדיונות לחודש {{{Month}}} כמפורט בלינק. נודה על הזנת הפדיון בהקדם. בכל שאלה ניתן ליצור קשר במייל חוזר או בטלפון 077-6001701 או ווצאפ 055-2677777
</td>
</tr>
<tr>
<td>
...
from members
where NotificationStrategy in (1,12,2,22,3,32,5,52)
union
-----------------------------------------------------------------------------------------------
-- Initial SMS
select 
...
5 as dayOfMonth, 
'06:00:00' as timeofday, 
N'שלום רב. מצורף בזאת לינק לאתר באמצעותו הנך מתבקש לדווח את הפדיונות לחודש {{{Month}}} כמפורט בלינק. נודה על הזנת הפדיון בהקדם. בכל שאלה ניתן ליצור קשר במייל חוזר או בטלפון 077-6001701.  ככל שהנך מדווח רק ביחס לחנות אחת הינך יכול לרשום את הפדיון ללא נקודות ב SMS ולשלוח אותו בחזרה, ואין צורך להכנס לאתר. {{{MagicLink}}}' as notificationBody,
N'לינק לקליטת פדיונות לחודש {{{Month}}}' as notificationTitle
from members
...
<tr>
<td align="center" bgcolor="#70bbd9" style="padding:40px 0 30px 0;color:#153643;font-size:28px;font-weight:bold;font-family:Arial,sans-serif">
<img src="" alt="תזכורת לדיווח פדיון" width="300" height="230" style="display:block" />
</td>
</tr>
<tr>
<td bgcolor="#ffffff" style="padding:40px 30px 40px 30px">
...
from members
where NotificationStrategy in (1,12,5,52)
union
----------------------------------------------------------------------------------------------------------
-- 12 Phone reminder
select 
...
<tr>
<td align="center" bgcolor="#70bbd9" style="padding:40px 0 30px 0;color:#153643;font-size:28px;font-weight:bold;font-family:Arial,sans-serif">
<img src="" alt="דיוווח פדיון" width="300" height="230" style="display:block" />
</td>
</tr>
<tr>
<td bgcolor="#ffffff" style="padding:40px 30px 40px 30px">
...
N'קליטת פדיונות לחודש {{{Month}}}' as notificationTitle
from members
where email = 'shlomi@mallshoplink.com'
---------------------------------------------------------------------------------
