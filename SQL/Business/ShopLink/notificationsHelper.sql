...
-- set identity_insert Arch_notificationScheuduling on
...
-- set identity_insert Arch_notificationScheuduling off
...
<tr>
<td style="padding:20px 0 30px 0;color:#153643;font-family:Arial,sans-serif;font-size:16px;line-height:20px">
שלום רב. למרות קבלת התראות ותזכורות רבות טרם דווחו פדיונות חודש {{{Month}}} לביג. ככל שלא ידווח בשעות הקרובות נאלץ לערב את מנהל הקניון בענין. רצ"ב שוב לינק להזנת הפדיונות. בכל שאלה ניתן ליצור קשר במייל חוזר או בטלפון 077-6001701
</td>
</tr>
<tr>
<td>
